...
# Stage 3 of germline-pangenome-gpu.cwl: everything after the lanes are mapped --
...
#
# Used as a subworkflow by Workflows/germline-pangenome-gpu.cwl, and run on its own by
